...
class _OnBoarding11State extends State<OnBoarding11> with TickerProviderStateMixin{
  var selectedGender = [];
     ...
     return Scaffold(
       body:
         Column(
           ...
           children: [
             Container(
               child: Text(style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),'What’s your gender? '),
             ),
             Container(
                 child: Image.asset(
                     'assets/gender.png')),
                   ...
                   InkWell(
                     ...
                     child: Padding(
                       ...
                       child: Container(
                         ...
                         child:
                         Text(textAlign: TextAlign.center, 'Female'),
                       ),
                     ),
                   ),
                   InkWell(
                     ...
                     child: Padding(
                       ...
                       child: Container(
                         ...
                         child:
                         Text(textAlign: TextAlign.center, 'Male'),
                       ),
                     ),
                   ),
                   InkWell(
                     ...
                     child: Padding(
                       ...
                       child: Container(
                         ...
                         child:
                         Text(textAlign: TextAlign.center, 'Other'),
                       ),
                     ),
                   ),
                 ],
